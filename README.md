...
Then you can just run `perl .\annotate_variation.pl ex3.avinput .\sarscov2db\ -build NC_045512v2 -dbtype avGene -out ex3` to annotate these mutations. Examine the output file to see what proteins these mutations affect, and what amino acid changes that they cause.
